...
class Game:
    ...
    def _generate_order(self):
        """Generate a random order for the player."""
        self.orders = []
        ...
        print(f"   ✓ Order generated with {num_items} product types")
    ...
    def _draw_ui(self):
        ...
        # Draw orders
        orders_y = 20
        orders_text = self.font.render("Current Order:", True, TEXT_COLOR)
        self.screen.blit(orders_text, (SCREEN_WIDTH // 2 - 100, orders_y + 40))
        ...
        for i, order in enumerate(self.orders):
            ...
            self.screen.blit(order_text, (SCREEN_WIDTH // 2 - 100, orders_y + 70 + i * 25))
